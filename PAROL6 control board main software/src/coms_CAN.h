...
/**
  ******************************************************************************
  * @file    coms_CAN.h (заголовочный файл для связи по CAN)
  * @brief   Этот файл предоставляет код для всех прототипов функций файла communication_CAN.cpp
  * @author Petar Crnjak
  ******************************************************************************
  * @attention (ВНИМАНИЕ)
  *
...
/* Включение необходимых библиотек и заголовочных файлов */
